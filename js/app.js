...
document.querySelector('#marca').addEventListener('input', e => {
     ...
     switch(e.target.value){
          case '1':
                document.querySelector('#porcentaje').innerHTML=` Por este auto tiene un aumento 50%`;
               break;
          case '2':
                document.querySelector('#porcentaje').innerHTML=` Por este auto tiene un aumento 25%`;
               break;
          case '3':
                document.querySelector('#porcentaje').innerHTML=` Por este auto tiene un aumento 35%`;
               break;
     }
setTimeout(() => {
...
document.querySelector('#reinicio').addEventListener('click',e=>{
     alert("Reiniciando el formulario");
     location.reload();
})
...
Interfaz.prototype.mostrarResultado = function(seguro, total) {
     ...
     if(seguro.tipo=='COMPLETO')
     {
alert('La mejor decisicion calidad,precio ');
     }
     else{
          alert('El mejor seguro de la empresa , Excelente decision');
     }
     div.innerHTML = `
